Before cloning the project, ensure you connect to your database and review the queries in the routes folder, modifying them if needed to match your database structure.
